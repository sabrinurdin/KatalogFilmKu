...
import static com.example.favoritku.db.DatabaseContract.getColumnInt;
import static com.example.favoritku.db.DatabaseContract.getColumnString;
...
public class Favorit implements Parcelable {
    ...
    private  String vote;
    public Favorit(JSONObject object){
        try {
