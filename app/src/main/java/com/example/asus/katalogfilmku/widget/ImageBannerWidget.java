...
public class ImageBannerWidget extends AppWidgetProvider {
    ...
    public static final String TOAST_ACTION = "com.example.asus.katalogfilmku.TOAST_ACTION";
    public static final String EXTRA_ITEM = "com.example.asus.katalogfilmku.EXTRA_ITEM";
