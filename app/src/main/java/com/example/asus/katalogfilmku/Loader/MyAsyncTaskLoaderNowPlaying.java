...
public class MyAsyncTaskLoaderNowPlaying extends AsyncTaskLoader<ArrayList<FilmItems>> {
    ...
    public ArrayList<FilmItems> loadInBackground() {
        ...
        String url = "https://api.themoviedb.org/3/movie/now_playing?api_key="+ BuildConfig.API_KEY+"&language=en-US&query=";
